...
begin
  ...
  ',sh_parvande,somn,entegale_somn,(tedade_sahme_ashari-somn) as max_entegal,kharid_somn,cod_reshteei,entegal_az_id,id from t_sahamdaran  where cod_reshteei like '+
      ...
      frm_show_exist_entegal.Caption:='«‰ ﬁ«·Â«ÌÌ òÂ „” ﬁÌ„« «“ '+Dm.ADOQ_show_nafarat_baraye_dadane_sahmname.AsString+' '+Dm.ADOQ_show_nafarat_baraye_dadane_sahmfamily.AsString+' «‰Ã«„ ‘œÂ «‰œ';
...
begin
      ...
      ',tedade_sahme_ashari=tedade_sahme_ashari-'+FloatToStr(ekhtelaf)+',noe_entegal='+QuotedStr('Êﬁ›');
...
begin
      ...
      Dm.ADOQ_show_nafarat_baraye_dadane_sahm.sql.Text:='update t_sahamdaran set sh_parvande='+QuotedStr(e_sh_parvande.Text)+
      ',tarikh='+QuotedStr(tarikh)+',noe_entegal='+QuotedStr('Êﬁ›');
