...
begin
      ...
      begin
            ...
            frm_show_exist_entegal.Caption:='ÇäÊŞÇáåÇíí ˜å ãÓÊŞíãÇğ ÇÒ '+Dm_eslah.ADOQ_show_entegalhaname.AsString+' '+Dm_eslah.ADOQ_show_entegalhafamily.AsString+' ÇäÌÇã ÔÏå ÇäÏ';
      ...
      begin
        if MessageBox(Handle,pchar('ÍĞİ ÇäÊŞÇá ÊÚÏÇÏ Óåã ÂÈ ÑÇ ÊÇííÏ ãí äãÇííÏ¿'),'ÊÇííÏ ÍĞİ !',MB_YESNO or MB_RIGHT or MB_RTLREADING or MB_ICONQUESTION)=id_yes then
        begin

            if Dm_eslah.ADOQ_show_entegalhanoe_entegal.AsString='Ëãä ÇÚíÇäí' then
            begin
            ...
            MessageBox(Handle,'Óåã ÂÈ äİÑ ÛíÑÇæá ÍĞİ äÔÏ!','ÊæÌå!',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION);
      end;
end;
end;
