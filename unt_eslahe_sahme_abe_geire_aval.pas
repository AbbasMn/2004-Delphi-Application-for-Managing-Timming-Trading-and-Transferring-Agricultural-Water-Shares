...
begin
    ...
    begin
      ...
      MessageBox(Handle,pchar(' Õœ«òÀ— „Ì  Ê«‰  ⁄œ«œ << '+FloatToStr(x1)+' >> ”Â„ ¬» »Â  ⁄œ«œ ”Â„ «‰ ﬁ«·Ì «÷«›Â ‰„Êœ'),'Œÿ« !',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION);
...
begin
    ...
    begin
      ...
      MessageBox(Handle,pchar(' ⁄œ«œ ”Â„ ¬» Ê«—œ ‘œÂ «“ „Ã„Ê⁄  ⁄œ«œ ”Â„ ¬»Â«ÌÌ òÂ «“ «Ì‰ „Ê—œ «‰ ﬁ«· Ì«› Â «‰œ = '+Dm.ADOQ_jame_kole_sahme_abkol_.AsString+' ò„ — „Ì »«‘œ ° ·–« ﬁ«œ— ‰„Ì »«‘Ìœ  ⁄œ«œ ”Â„ ¬» «Ì‰ „Ê—œ —« »—«»— »« '+l_tedad_sahme_abe_ashari.Caption+' À»  ‰„«ÌÌœ '),'Œÿ« !',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION);
  ...
  ',sh_parvande,cod_reshteei,entegal_az_id,id,somn,entegale_somn,(tedade_sahme_ashari-somn) as max_entegal,kharid_somn from t_sahamdaran where cod_reshteei like '+
      ...
      begin
        ...
        frm_show_exist_entegal.Caption:='«‰ ﬁ«·Â«ÌÌ òÂ „” ﬁÌ„« «“ '+Dm_eslah.ADOQ_show_entegalhaname.AsString+' '+Dm_eslah.ADOQ_show_entegalhafamily.AsString+' «‰Ã«„ ‘œÂ «‰œ';
...
begin
  if RadioGroup2.ItemIndex=1 then
      ...
      ' and noe_entegal='+QuotedStr('À„‰ «⁄Ì«‰Ì');
      Dm_eslah.ADOQ_show_entegalha2.ExecSQL;
     ...
     MessageBox(Handle,pchar('„‘Œ’«  ”Â„ ¬» À»  ‘œÂ ° »—Ê“ —”«‰Ì ê—œÌœ'),' ÊÃÂ !',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONINFORMATION);
end;
...
begin /////tagire shomare parvande
    ...
    if Dm.ADOQ_show_afrad.RecordCount>0 then
    begin
      MessageBox(Handle,pchar('«‰ ﬁ«·Â«ÌÌ «“ «Ì‰ ”Â„ ¬» «‰ Œ«»Ì ÊÃÊœ œ«—‰œ òÂ »« ‘„«—Â Å—Ê‰œÂ ›⁄·Ì À»  ‘œÂ «‰œ ‘«Ìœ ‰Ì«“ »«‘œ ‘„«—Â Å—Ê‰œÂ Â«Ì ¬‰Â« —« ‰Ì“  €ÌÌ— œÂÌœ'),' ÊÃÂ !',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION);
...
begin
  ...
  ',sh_parvande,somn,entegale_somn,(tedade_sahme_ashari-somn) as max_entegal,kharid_somn,cod_reshteei,entegal_az_id,id,somn,entegale_somn,(tedade_sahme_ashari-somn) as max_entegal,kharid_somn from t_sahamdaran where cod_reshteei like '+
    ...
    begin
      ...
      MessageBox(Handle,pchar('»Â œ·Ì· òÂ «“ ”Â„ ¬» ›⁄·Ì ° «‰ ﬁ«·Â«ÌÌ »Â »ﬁÌÂ «›—«œ «‰Ã«„ ê—› Â ° ‰„Ì  Ê«‰Ìœ ”Â„ ¬» —« »Â ’Ê—  Êﬁ› À»  ‰„«ÌÌœ. „Ì  Ê«‰Ìœ Â„Â «‰ ﬁ«·Â«Ì «‰Ã«„ ‘œÂ —« Õ–› ‰„ÊœÂ ”Å” ”Â„ ¬» —« »Â ’Ê—  Êﬁ› À»  ‰„«ÌÌœ.'),'Œÿ« !',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION);
...
begin
  ...
  begin
    if Dm_eslah.ADOQ_show_entegalhanoe_entegal.AsString='À„‰ «⁄Ì«‰Ì' then
    begin
           MessageBox(Handle,pchar('»œ·Ì· «Ì‰òÂ «‰ ﬁ«· «‰ Œ«»Ì »’Ê—  À»  À„‰ «⁄Ì«‰Ì »—«Ì “‰/Œ«‰„ »ÊœÂ ° »‰«»— «Ì‰ ‰„Ì  Ê«‰  ⁄œ«œ ”Â„ —«  €ÌÌ— œ«œ'),'Œÿ« !',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION);
     exit;
    end;
    ...
    begin
    if Dm_eslah.ADOQ_show_entegalhanoe_entegal.AsString<>'Êﬁ›' then ////vagf nabashe
    begin
    ...
    if ComboBox1.Text<>'Êﬁ›' then ////vagf nabashe
    begin
      if check_vorod_moshakhasate_kharida then
      begin
